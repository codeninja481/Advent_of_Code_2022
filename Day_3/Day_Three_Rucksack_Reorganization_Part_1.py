...
Each rucksack has two large compartments. All items of a given type are meant to go into exactly one of the two compartments. The Elf that did the packing failed to follow 
...
#Ruck contains: jqHRNqRjqzjGDLGLrsFMfFZSrLrFZsSL which has 32 items, 16 items per compartment.  Compartment 1 contains: jqHRNqRjqzjGDLGL and  compartment 2 contains: rsFMfFZSrLrFZsSL
#Ruck contains: PmmdzqPrVvPwwTWBwg which has 18 items, 9 items per compartment.  Compartment 1 contains: PmmdzqPrV and  compartment 2 contains: vPwwTWBwg
#Ruck contains: wMqvLMZHhHMvwLHjbvcjnnSBnvTQFn which has 30 items, 15 items per compartment.  Compartment 1 contains: wMqvLMZHhHMvwLH and  compartment 2 contains: jbvcjnnSBnvTQFn
#Ruck contains: ttgJtRGJQctTZtZT which has 16 items, 8 items per compartment.  Compartment 1 contains: ttgJtRGJ and  compartment 2 contains: QctTZtZT
#Ruck contains: CrZsJsPPZsGzwwsLwLmpwMDw which has 24 items, 12 items per compartment.  Compartment 1 contains: CrZsJsPPZsGz and  compartment 2 contains: wwsLwLmpwMDw